...
const Card = ({ playerDetails, onBetClick, showAttributes = true }) => {
  ...
  const ClickHandler = (event) => {
    ...
    selectedAtrribute.current.selectedAttributeIndex = target.id;
    selectedAtrribute.current.selectedAttributeValue = target.innerText;
